-- Indicador: Remuneração média dos vínculos formais em ocupações culturais de trabalhadores classificados como raça/cor branca, nos municípios do estado do Rio de Janeiro, em 2025
-- Fonte: RAIS 2025 - Base dos Dados
-- Unidade de análise: município
-- Filtro ocupacional: CBO 2002 - lista de ocupações culturais
-- Variável de remuneração: valor_remuneracao_media_brancos
